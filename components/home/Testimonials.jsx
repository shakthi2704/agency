...
import loadBackgroundImages from "@/utils/loadBackgroudImages"
...
const Testimonials = () => {
  ...
  return (
    <section
      ...
      data-background="/assets/images/background/b1.jpg"
      data-overlay-dark="9"
    >
                      ...
                      <div className="info d-flex align-items-center pt-40 mt-40 bord-thin-top">
                        <div>
                          <div className="fit-img circle">
                            <Image
                              src="/assets/images/testim/t1.jpg"
                              alt=""
                              width={600}
                              height={600}
                            />
                    ...
                    <div className="content">
                      ...
                      <div className="info d-flex align-items-center pt-40 mt-40 bord-thin-top">
                        <div>
                          <div className="fit-img circle">
                            <Image
                              src="/assets/images/testim/t2.jpg"
                              alt=""
                              width={600}
                              height={600}
                            />
